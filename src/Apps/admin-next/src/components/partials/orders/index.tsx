...
const MOCK_ORDERS = [
  {
    ...
    createdOnUtc: "2024-01-15T08:30:00Z",
    orderItems: [
      { id: "1", productName: "Laptop Dell XPS 13", quantity: 1, price: 25000000 },
      { id: "2", productName: "Mouse Logitech", quantity: 1, price: 500000 },
    ],
    finalPrice: 25500000,
    status: 1,
    cancelReason: null,
  ...
  },
  {
    ...
    createdOnUtc: "2024-01-14T14:20:00Z",
    orderItems: [
      { id: "3", productName: "iPhone 15 Pro", quantity: 1, price: 28000000 },
    ],
    finalPrice: 28000000,
    status: 2,
    cancelReason: null,
  ...
  },
  {
    ...
    createdOnUtc: "2024-01-13T09:15:00Z",
    orderItems: [
      { id: "4", productName: "Samsung Galaxy S24", quantity: 1, price: 22000000 },
      { id: "5", productName: "AirPods Pro", quantity: 1, price: 5000000 },
      { id: "6", productName: "Charger", quantity: 1, price: 500000 },
    ],
    finalPrice: 27500000,
    status: 3,
    cancelReason: null,
  ...
  },
  {
    ...
    createdOnUtc: "2024-01-12T16:45:00Z",
    orderItems: [
      { id: "7", productName: "MacBook Air M3", quantity: 1, price: 32000000 },
      { id: "8", productName: "USB-C Hub", quantity: 1, price: 1200000 },
    ],
    finalPrice: 33200000,
    status: 4,
    cancelReason: null,
  ...
  },
  {
    ...
    createdOnUtc: "2024-01-11T11:30:00Z",
    orderItems: [
      { id: "9", productName: "iPad Pro 12.9", quantity: 1, price: 28000000 },
      { id: "10", productName: "Apple Pencil", quantity: 1, price: 3500000 },
    ],
    finalPrice: 31500000,
    status: 5,
    cancelReason: null,
  ...
  },
  {
    ...
    createdOnUtc: "2024-01-10T13:20:00Z",
    orderItems: [
      { id: "11", productName: "Sony WH-1000XM5", quantity: 1, price: 8500000 },
    ],
    finalPrice: 8500000,
    status: 6,
    cancelReason: "Customer requested cancellation due to change of mind",
    refundReason: null,
  },
  {
    id: "7",
    ...
    createdOnUtc: "2024-01-09T10:00:00Z",
    orderItems: [
      { id: "12", productName: "Nintendo Switch OLED", quantity: 1, price: 7500000 },
      { id: "13", productName: "Zelda Game", quantity: 1, price: 1500000 },
    ],
    finalPrice: 9000000,
    status: 7,
    cancelReason: null,
    refundReason: "Defective product - customer requested refund",
  },
  {
    id: "8",
    ...
    createdOnUtc: "2024-01-08T15:30:00Z",
    orderItems: [
      { id: "14", productName: "Canon EOS R50", quantity: 1, price: 18000000 },
      { id: "15", productName: "Lens 50mm f/1.8", quantity: 1, price: 4500000 },
      { id: "16", productName: "Memory Card 128GB", quantity: 2, price: 800000 },
    ],
    finalPrice: 24100000,
    status: 2,
    cancelReason: null,
  ...
  },
  {
    ...
    createdOnUtc: "2024-01-07T09:45:00Z",
    orderItems: [
      { id: "17", productName: "Gaming Monitor 27 inch", quantity: 1, price: 6500000 },
      { id: "18", productName: "Mechanical Keyboard", quantity: 1, price: 2500000 },
    ],
    finalPrice: 9000000,
    status: 1,
    cancelReason: null,
  ...
  },
  {
    ...
    createdOnUtc: "2024-01-06T14:00:00Z",
    orderItems: [
      { id: "19", productName: "Robot Vacuum", quantity: 1, price: 12000000 },
    ],
    finalPrice: 12000000,
    status: 4,
    cancelReason: null,
...
const Orders= () => {
  ...
  // Fetch orders from mock data with 500ms delay
  const fetchOrders = useCallback(async () => {
    try {
      setLoading(true);
      // Simulate API delay
      await new Promise((resolve) => setTimeout(resolve, 500));
      console.log("Orders mock data loaded:", MOCK_ORDERS);
  ...
  // SignalR connection removed - using mock data only
    ...
    (order) => {
      ...
      setUpdateStatus(
        availableStatuses.length > 0
          ? availableStatuses[0].value.toString()
          : "",
      );
      setUpdateReason("");
  ...
  const handleStatusUpdate = async () => {
    ...
    try {
      console.log("Updating order status locally:", selectedOrder.id, {
        status: statusValue,
        reason: updateReason,
      });
      ...
      // Update order locally in mock data
        ...
        prevOrders.map((order) => {
          if (order.id === selectedOrder.id) {
            return {
              ...order,
              status: statusValue,
              cancelReason: statusValue === 6 ? updateReason : order.cancelReason,
              refundReason: statusValue === 7 ? updateReason : order.refundReason,
            };
          }
          return order;
        })
        ...
        Cell: (row) => {
          ...
          const handleReasonClick= () => {
            ...
            setSelectedReasonType(
              isCanceled ? t("orders.cancelled") : t("orders.refunded"),
            );
          ...
          return (
            <div className="flex space-x-3 rtl:space-x-reverse">
              <Tooltip
                ...
                <Link href={`/orders/${order.id}`} className="action-btn">
            ...
            <div className="mb-4">
              <p className="text-sm text-slate-600 dark:text-slate-300">
                ...
                <span className="font-semibold">
                  {selectedOrder.orderNo || selectedOrder.orderNumber}
                </span>
              </p>
            </div>
          )}
            ...
            <Select
              ...
              options={
                selectedOrder && selectedOrder.status !== undefined
                  ? getAvailableStatuses(selectedOrder.status, t).map(
                      (opt) => ({
