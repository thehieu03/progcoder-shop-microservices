...
const CreateCoupon= () => {
  ...
  const validationSchema = Yup.object({
    code: Yup.string().trim().required(t("createCoupon.codeRequired")),
    ...
    discountValue: Yup.number()
      ...
      .test("max-percent", t("createCoupon.percentMaxError"), function (value) {
    ...
    maxDiscount: Yup.number()
      ...
      .test(
        ...
        function (value) {
          if (
            this.parent.hasMaxDiscount &&
            this.parent.discountType === "percent" &&
            !value
          ) {
            return false;
          }
    ...
    endDate: Yup.date()
      .required()
      .test("after-start", t("createCoupon.dateError"), function (value) {
    ...
    onSubmit: async (values) => {
      try {
        ...
        const dto = {
          ...
          usageLimit: values.hasUsageLimit ? parseInt(values.usageLimit) : 1000, // Default to 1000 if no limit
          maxDiscountAmount:
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  <Textinput
                    ...
                    type="number"
                    placeholder={
                      formik.values.discountType === "percent" ? "10" : "50000"
                    }
            ...
            <div className="space-y-3 text-sm">
              <div className="flex justify-between">
                <span className="text-slate-500">
                  {t("createCoupon.discountTypeLabel")}
                </span>
