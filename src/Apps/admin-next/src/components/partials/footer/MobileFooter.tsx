    ...
    <div className="bg-white bg-no-repeat custom-dropshadow footer-bg dark:bg-slate-700 flex justify-around items-center backdrop-filter backdrop-blur-[40px] fixed left-0 w-full z-9999 bottom-0 py-[12px] px-4">
        ...
        <div>
          <span
            className={`relative cursor-pointer rounded-full text-[20px] flex flex-col items-center justify-center mb-1
              ${pathname === "/chat" ? "text-primary-500" : "dark:text-white text-slate-900"}
            `}
          >
          ...
          <span
            className={`block text-[11px]
              ${pathname === "/chat" ? "text-primary-500" : "text-slate-600 dark:text-slate-300"}
            `}
          >
            Messages
          </span>
      ...
      >
        <div className="h-[50px] w-[50px] rounded-full relative left-[0px] top-[0px] custom-dropshadow">
          <img
            src={FooterAvatar.src}
            alt=""
            className={`w-full h-full rounded-full
              ${pathname === "/profile" ? "border-2 border-primary-500" : "border-2 border-slate-100"}
            `}
          />
        </div>
      </Link>
      <Link href="/notifications">
        <div>
          <span
            className={`relative cursor-pointer rounded-full text-[20px] flex flex-col items-center justify-center mb-1
              ${pathname === "/notifications" ? "text-primary-500" : "dark:text-white text-slate-900"}
            `}
          >
          ...
          <span
            className={`block text-[11px]
              ${pathname === "/notifications" ? "text-primary-500" : "text-slate-600 dark:text-slate-300"}
            `}
          >
            Notifications
          </span>
