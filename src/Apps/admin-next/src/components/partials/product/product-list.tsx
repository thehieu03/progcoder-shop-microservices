...
const mapStatus = (displayStatus: string): ProductStatus => {
...
const Ecommerce= () => {
  ...
  const mockProducts: Product[] = useMemo(() => [
    ...
    },
    {
      ...
      published: true,
      featured: false,
      image: "https://placehold.co/60x60/e2e8f0/475569?text=Switch",
      status: "in_stock",
    },
    {
      id: "9",
      ...
      sku: "LOG-MX3S",
      categories: "Phụ kiện, Logitech",
      brand: "Logitech",
      price: 2490000,
      salePrice: 2190000,
      published: true,
      featured: false,
      image: "https://placehold.co/60x60/e2e8f0/475569?text=Logitech",
      status: "active",
    },
    {
      id: "10",
      ...
      sku: "SS-T7-1TB",
      categories: "Phụ kiện, Samsung",
      brand: "Samsung",
      price: 2990000,
      salePrice: null,
      published: false,
      featured: false,
      image: "https://placehold.co/60x60/e2e8f0/475569?text=SSD",
      status: "draft",
    },
  ], []);

  // Fetch products from API (using mock data)
  ...
  const confirmDelete = async () => {
    ...
    try {
      ...
      // Remove the deleted product from the list (local only)
  ...
  const confirmPublish = async () => {
    ...
    try {
      ...
      // Update the product in the list (local only)
      setProducts((prevProducts) =>
  ...
  const data = useMemo<Product[]>(() => products, [products]);
