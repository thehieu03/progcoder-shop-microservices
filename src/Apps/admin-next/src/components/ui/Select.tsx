...
// Type for option objects
interface OptionObject {
  value: string | number;
  label: string;
}

// Type for options - can be array of strings, numbers, or objects
export type SelectOption = string | number | OptionObject;
...
const Select: React.FC<SelectProps> = ({
  ...
  const options = optionsProp || Array(3).fill("option");

  const isOptionObject = (option: SelectOption): option is OptionObject => {
    return (
